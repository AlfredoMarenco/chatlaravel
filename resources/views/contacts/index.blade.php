<x-app-layout>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="flex justify-end mb-4">
            <a href="{{ route('contacts.create') }}" class="text-sm text-blue-600 hover:text-blue-500">
                {{ __('Add new contact') }}
            </a>
        </div>
            ...
            <div class="flex w-full mx-auto overflow-hidden bg-white rounded-lg shadow-md {{-- {{--dark:bg-gray-800 --}} --}}">
                ...
                <div class="px-4 py-2 -mx-3">
                    <div class="mx-3">
                        ...
                        <p class="text-sm text-gray-600 {{-- dark:text-gray-200 --}}">Aun no tienes contactos</p>
                    </div>
                </div>
            </div>
        @endif
