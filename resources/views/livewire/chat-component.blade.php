        ...
        <div class="col-span-1">
            <div class="bg-gray-100 h-16 flex items-center px-4">
                <img src="{{ auth()->user()->profile_photo_url }}"
                    class="w-10 h-10 object-cover object-center rounded-full" alt="{{ auth()->user()->name }}">
            </div>
            <div class="bg-white h-14 flex items-center px-4">
                <x-jet-input class="block w-full" type="text" placeholder="Busca un chat o inicia uno nuevo"
                    wire:model="search" />
            </div>
            ...
            @else
                <div class="w-full h-full flex justify-center items-center">
                    <div>
                        <div class="WM0_u" style="transform: scale(1); opacity: 1;"><span
                                ...
                                class="IVxyB"><svg width="360" viewBox="0 0 303 172" fill="none"
                                    ...
                                    <rect x=".445" y=".55" width="50.403" height="99.722" rx="7.5"
                                        transform="rotate(6 -356.664 123.217) skewX(.036)" fill="#fff" stroke="#316474">
                                    </rect>
                                    <path
                        ...
                        <h1 class="text-center text-gray-500 text-2xl mt-4">Chat de soporte</h1>
                    </div>
                </div>
            @endif
        </div>
